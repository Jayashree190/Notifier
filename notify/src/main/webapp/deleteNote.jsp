	...
	<div class="container-fluid">
		...
		<div class="modal-content">
			<div class="modal-header text-center">
				<h4 class="modal-title w-100 font-weight-bold">DELETE NOTE</h4>
			</div>
			<div class="modal-body mx-3">
				<form action="deleteNote" method="post">
					<label for="noteBookName">Click YES if your are sure to delete the Note</label> <input type="hidden"
