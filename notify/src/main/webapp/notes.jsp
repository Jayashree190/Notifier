	...
	<div class="container-fluid">
		...
		<ul class="nav navbar-nav navbar-left">
			...
			<div id="mySidenav" class="sidenav">
				...
				<a id="listOfNotes" href="note">Notes</a> 
		...
		<ul class="nav navbar-nav navbar-right">
			...
			<li><a  id="addNewNote" href="newNote.jsp" data-toggle="modal"
...
<c:forEach items="${noteObjDate}" var="note"> 
			<h3><a id="dailyTask"
				href="showNote"><% String nname= (String)(session.getAttribute("noteName")); out.print(nname); %></a></h3>
			<p>StartDate :<% String sd= (String)(session.getAttribute("sdate")); out.print(sd); %></p>
			<p>EndDate   : <% String ed= (String)(session.getAttribute("edate")); out.print(ed); %> </p>
		...
		<% i=i+1; %>
			<tr>
				...
				<div name="myTable">
								...
								<div class="panel-body">
									<div class="row">
										<div class="col-md-1 text-left">
											<a  id="notedetails" href="showNote"> <% String nname= (String)(session.getAttribute("noteName")); out.print(nname); %>
												
												</a>
										</div>
										<div class="col-md-2 text-left">Started on: <% String sd= (String)(session.getAttribute("sdate")); out.print(sd); %></div>
										...
										<div class="col-md-10 text-right">
											<a id="editNote"  href="editNote.jsp"><span
												class="glyphicon glyphicon-edit" >Edit</span></a>
										</div>
										<div>
											<a href="deleteNote.jsp"><span
                    ...
                    <div class="panel-body">
                    <% String d= (String)(session.getAttribute("des")); out.print(d); %>
                     </div>
