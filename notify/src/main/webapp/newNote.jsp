		...
		<div class="modal-content">
			...
			<form action="insertNote" method="post">
					<label for="noteBookName">NoteBookName</label> 
					 ...
					 <label for="startDate">StartDate</label> <input type="date" id="startDate" name="startDate" placeholder="Start date">
					 <label for="endDate">EndDate</label> <input type="date" id="endDate" name="endDate" placeholder="End date">
					 <label for="remainderDate">RemainderDate</label> <input type="date" id="remainderDate" name="remainderDate" ><br>
					 <label for="noteBookId_"></label> <input type="hidden"  name="noteBookId_" ><br>
					 ...
					 <center><input type="submit" id="submit" value="save"></center>
			</form>
			</div>
		</div>
		</div>
