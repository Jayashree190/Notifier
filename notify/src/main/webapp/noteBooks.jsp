...
<body>
			...
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					...
					<div class="modal-body mx-3">
						<form action="addNoteBook" name="myForm"
	...
	<table id="myTable" class="container">
		<tr>
			<td><div id="error" style="color: red; display: block"></div></td>
		</tr>
							...
							<div class="panel-body">
								<div class="row">
									<div class="col-md-1 text-left"><b>
										<a  href="note"> <% String uname= (String)(session.getAttribute("nb_Name")); out.print(uname); %>
										</a></b>
										<div>
									...
									<div class="col-md-10 text-right">
										<a id="editNoteBook" href="editNoteBook.jsp"><span
											class="glyphicon glyphicon-edit">Edit</span></a>
									</div>
									<div>
										<a id="deleteNoteBook"  href="deleteNoteBook.jsp"><span
