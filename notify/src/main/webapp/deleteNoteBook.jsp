	...
	<div class="container-fluid">
		...
		<div class="modal-content">
			<div class="modal-header text-center">
				<h4 class="modal-title w-100 font-weight-bold">DELETE NOTEBOOK</h4>
			</div>
			<div class="modal-body mx-3">
				<form action="deleteNoteBook" method="post">
					<label for="noteBookName">Click YES if your are sure to delete the NoteBook</label> <input type="hidden"
